...
#deps for vncterm
pkg install -y net/libvncserver security/gnutls || true
...
cbsd module mode=install puppet || true
cbsd module mode=upgrade puppet || true

cbsd module mode=install convectix || true
cbsd module mode=upgrade convectix || true

cbsd module mode=install vncterm || true
cbsd module mode=upgrade vncterm || true
...
# clonosdb.d
cp -a /usr/local/cbsd/modules/clonosdb.d /root/myb-build/myb-extras/
rm -rf /root/myb-build/myb-extras/clonosdb.d/.git || true
# puppet.d
...
rm -rf /root/myb-build/myb-extras/vncterm.d/.git || true
make -C /root/myb-build/myb-extras/vncterm.d
strip /root/myb-build/myb-extras/vncterm.d/cbsdvnc
