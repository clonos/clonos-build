...
debian12_iso="${workdir}/src/iso/cbsd-cloud-Debian-x86-12.8.0.raw"
...
freebsd14_ufs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-ufs-14.2.0-CURRENT-amd64.raw"
freebsd14_zfs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-zfs-14.2.0-CURRENT-amd64.raw"
freebsd15_ufs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-ufs-15.0.5-CURRENT-amd64.raw"
freebsd15_zfs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-zfs-15.0.5-CURRENT-amd64.raw"
