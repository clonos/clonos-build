...
debian12_iso="${workdir}/src/iso/cbsd-cloud-Debian-x86-12.2.0.raw"
...
freebsd13_ufs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-ufs-13.2.0-RELEASE-amd64.raw"
freebsd13_zfs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-zfs-13.2.0-RELEASE-amd64.raw"
...
freebsd15_ufs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-ufs-14.0.10-CURRENT-amd64.raw"
freebsd15_zfs_iso="${workdir}/src/iso/cbsd-cloud-FreeBSD-ufs-15.0.1-CURRENT-amd64.raw"
...
openbsd7_iso="${workdir}/src/iso/cbsd-cloud-openbsd-74.raw"
